...
#[Route('demandes')]
class DemandeAppController extends AbstractController
{
    ...
    #[Route('/', name: 'app_demande_app_index', methods: ['GET'])]
    public function index(DemandeRepository $demandeRepository, StatutLotissementRepository $statutLotissementRepository): Response
    {
        ...
        return $this->render('admin/demande_app/index.html.twig', [
    ...
    #[Route('/demadeur/new', name: 'app_demande_demande_app_new', methods: ['GET', 'POST'])]
    public function newDemandeur(
        ...
        return $this->render('admin/demande_app/nouvelle.html.twig', [
            'form' => $form,
        ]);
    }


    #[Route('/new', name: 'app_demande_app_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin/demande_app/new.html.twig', [
            'demande' => $demande,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_demande_app_show', methods: ['GET'])]
    public function show(Demande $demande): Response
    {
        return $this->render('admin/demande_app/show.html.twig', [
            'demande' => $demande,
        ]);
    }

    #[Route('/{id}/edit', name: 'app_demande_app_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, Demande $demande, EntityManagerInterface $entityManager): Response
    {

        $form = $this->createForm(DemandeEditType::class, $demande);
        $form->handleRequest($request);
        ...
        return $this->render('admin/demande_app/edit.html.twig', [
            'demande' => $demande,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_demande_app_delete', methods: ['POST'])]
    ...
    #[Route('/statut/{id}', name: 'app_demande_statut_app_update', methods: ['GET', 'POST'])]
    public function changestatut(
        ...
        $res =  $orangeService->sendSMS($demande->getDemandeur()->getTelephone(), "Bonjour , votre document est " . $demande->getStatut()->getDenomination());
