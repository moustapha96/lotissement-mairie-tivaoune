...
#[Route('lotissements')]
class LotissementAppController extends AbstractController
{
    #[Route('/', name: 'app_lotissement_app_index', methods: ['GET'])]
    public function index(LotissementRepository $lotissementRepository): Response
    {
        return $this->render('admin/lotissement_app/index.html.twig', [
    ...
    #[Route('/{id}/parcelles', name: 'app_lotissement_parcelle_app_index', methods: ['GET'])]
    public function parcelles(Lotissement $lotissement, ParcelleRepository $parcelleRepository): Response
    {
        ...
        return $this->render('admin/lotissement_app/parcelle.html.twig', [
    ...
    #[Route('/{id}/demandes', name: 'app_lotissement_demande_app_index', methods: ['GET'])]
    public function demandes(
        Lotissement $lotissement,
        StatutLotissementRepository $statutLotissementRepository
    ): Response {
        return $this->render('admin/lotissement_app/demande.html.twig', [
            'lotissement' => $lotissement,
    ...
    #[Route('/{id}/plans', name: 'app_lotissement_plan_app_index', methods: ['GET'])]
    public function plans(Lotissement $lotissement, PlanRepository $planRepository): Response
    {

        return $this->render('admin/lotissement_app/plan.html.twig', [
            'lotissement' => $lotissement,
    ...
    #[Route('/new', name: 'app_lotissement_app_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_lotissement_app_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->render('admin/lotissement_app/new.html.twig', [
            'lotissement' => $lotissement,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_lotissement_app_show', methods: ['GET'])]
    public function show(Lotissement $lotissement): Response
    {
        return $this->render('admin/lotissement_app/show.html.twig', [
            'lotissement' => $lotissement,
        ]);
    }

    #[Route('/{id}/edit', name: 'app_lotissement_app_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, Lotissement $lotissement, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin/lotissement_app/edit.html.twig', [
            'lotissement' => $lotissement,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_lotissement_app_delete', methods: ['POST'])]
